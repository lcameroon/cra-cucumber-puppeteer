...
const { createFolder } = require('./support/util/FileSystem');
...
const config = {
  ...
  reportPath: process.env.REPORT_PATH ? process.env.REPORT_PATH : './reports',
  ...
  // Defaults to /screenshots if a SCREENSHOT_PATH environment variable isn't pressent.
