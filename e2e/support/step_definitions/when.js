...
const setElementStyle = require('../action/setElementStyle');
const setElementValue = require('../action/setElementValue');
const setUserAgent = require('../action/setUserAgent');
...
When('I open the url {string-env} with device {string}', async function (url, device) {
...
When('I set the browser viewport to {int}px width by {int}px height', resizeScreenSize);
...
When('I press the {string} key on the {string} element', async function (key, selector) {
